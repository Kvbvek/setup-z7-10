...
HD_PWD='/home/jakub/vivado_projects/zybo_z7-10_1/ip_create/ip_repo/ip_counter/edit_ip_counter_v1_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ip_counter_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ip_counter_v1_0.tcl
