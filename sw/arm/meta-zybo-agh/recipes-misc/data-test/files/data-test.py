...
DMA_BASE = 0x40400000
GPIO_BASE = 0x41200000       # <-- TU WPISZ SWÓJ ADRES AXI GPIO
MAP_SIZE = 0x10000

BUF_ADDR = 0x0A000000
BUF_SIZE = 1 * 1024 * 1024  # 1 MB

GPIO_DATA = 0x0             # rejestr danych GPIO
...
mm_gpio = mmap.mmap(fd, MAP_SIZE, mmap.MAP_SHARED,
...
def gpio_wr(val):
    struct.pack_into("<I", mm_gpio, GPIO_DATA, val)
