...
AXIL_CONTROL = 0x00         # bit0 = ENABLE/ENABLE
AXIL_LENGTH  = 0x04         # 32-bit length register
...
# Set amount of generated data via AXI-Lite
transfer_len = BUF_SIZE
print(f"Setting AXI-Lite LENGTH = {transfer_len}")
axil_wr(AXIL_LENGTH, transfer_len)

# ENABLE = 1 via AXI-Lite (was GPIO0)
...
# ENABLE = 0 after transfer (AXI-Lite)
print("ENABLE = 0 (AXI-Lite CONTROL)")
